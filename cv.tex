...
\begin{document}
	...
	``Provably Robust Machine Learning through Structure-Aware \\
	...
	\hfill\vspace*{-2\baselineskip}
	\begin{enumerate}[label={\arabic*.}]
		% \item Co-organizer of the \href{https://www.ml-verification.com/}{$3$nd Workshop on Formal Verification and Machine Learning (WFVML)}, International Conference on Machine Learning (ICML), 2024.
